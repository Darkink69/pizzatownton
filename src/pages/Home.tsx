              ...
              >
                <div className="flex justify-center">
                  <div className="relative w-28 mt-4">
                    <img
                      src={`${store.imgUrl}fridge_big.png`}
                      alt="Холодильник"
                ...
                <div className="p-4 pt-4 space-y-3">
                  ...
                  <button
                    disabled={
                      ...
                      isBuyingFood ||
                      (() => {
                        const daysLeft = store.foodStatus?.daysLeft;
                        const daysLeftNum =
                          typeof daysLeft === "string"
                            ? parseFloat(daysLeft)
                            : Number(daysLeft) || 0;
                        return daysLeftNum >= 1;
                      })()
                    }
                    onClick={() => {
                      // Проверяем значение daysLeft с учетом типа
                      const daysLeft = store.foodStatus?.daysLeft;
                      const daysLeftNum =
                        typeof daysLeft === "string"
                          ? parseFloat(daysLeft)
                      ...
                      if (!canBuyFood || isBuyingFood || daysLeftNum >= 1)
                        return;
                ...
                (() => {
                  ...
                  const daysLeftNum =
                    typeof daysLeft === "string"
                      ? parseFloat(daysLeft)
                      : Number(daysLeft) || 0;
                  return !canBuyFood || isBuyingFood || daysLeftNum >= 1;
                })()
