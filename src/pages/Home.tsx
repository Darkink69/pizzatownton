        ...
        {isModalOpen && (
          <>
            ...
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-11/12 max-w-md">
              ...
              {/* Контент поверх модального окна */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4/5 text-center">
             

              <div className="absolute top-[-20px] left-1/2 transform -translate-x-1/2 px-8 py-2 text-center shantell text-lg text-amber-800">
                ЭТАЖ 1 - УРОВЕНЬ 1
              </div>


              <div className="mt-2 mb-2 rounded-xl overflow-hidden">
                <img src={`${store.imgUrl}img_kitchen.png`} alt="Кухня" className="w-full h-full object-cover"/>
              </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="font-bold text-lg text-amber-800">Поваров:</div>
                  <div className="text-xl font-bold text-amber-800">0 / 5</div>
                  <button className="bg-yellow-400 hover:bg-yellow-300 px-6 py-2 rounded-xl font-bold text-lg shadow-md border-2 border-yellow-600">
                    +1
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="font-bold text-lg text-amber-800">Доходность Этажа:</div>
                  <div className="flex items-center gap-2">
                    <span className="text-xl font-bold text-amber-800">0</span>
                    <span className="bg-green-400 px-2 py-1 rounded-md text-sm font-bold">💰</span>
                    <span className="text-xl font-bold text-amber-800">/ час</span>
                  </div>
                  <button className="bg-yellow-400 hover:bg-yellow-300 px-6 py-2 rounded-xl font-bold text-lg shadow-md border-2 border-yellow-600">
                    +41
                  </button>
                ...
                <div className="flex items-center justify-between">
                  <div className="font-bold text-lg text-amber-800">Общая Доходность:</div>
                  <div className="flex items-center gap-2">
                    <span className="text-xl font-bold text-amber-800">0</span>
                    <span className="bg-green-400 px-2 py-1 rounded-md text-sm font-bold">💰</span>
                    <span className="text-xl font-bold text-amber-800">/ час</span>
              ...
              <div className="bg-red-600 hover:bg-red-700 rounded-xl p-4 flex items-center justify-between font-bold text-white text-lg shadow-lg border-2 border-red-800">
                <div>Этаж 1 - Улучшить до уровня 1</div>
                <div className="flex items-center gap-2">
                ...
                <button 
                  onClick={handleCloseModal}
                  className="absolute -top-58 -right-8 z-50"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_2679_1208)">
