                    ...
                    <div
                        ...
                        <div className="flex flex-col items-center relative">
                            {Array.from({length: floors}, (_, index) => {
                                ...
                                const manager = floorData?.staff?.find(s => s.staffName === "Manager");
                                const guard = floorData?.staff?.find(s => s.staffName === "Guard");
                                    ...
                                    {floorData.floorId} этаж
                                                            ...
                                                            {manager && (
                                                                <div className="flex items-center gap-1 -translate-x-[6px]">
                                                                    <img
                                                                        src={`${store.imgUrl}${
                                                                            manager.owned ? "Manager_icon.png" : "Manager_icon_0.png"
                                                                        }`}
                                                                        alt="Manager"
                                                                    ...
                                                                    <img
                                                                        src={`${store.imgUrl}${
                                                                            manager.owned ? "icon_star.png" : "icon_star_empty.png"
                                                                        }`}
                                                                        alt="Star"
                                                            ...
                                                            {guard && (
                                                                <div className="flex items-center gap-1 ml-2 -translate-x-[4px]">
                                                                    <img
                                                                        src={`${store.imgUrl}${
                                                                            guard.owned ? "Guard_icon.png" : "Guard_icon_0.png"
                                                                        }`}
                                                                        alt="Guard"
                                                                        className="w-6 h-6 sm:w-8 sm:h-8"
                                                                    />
                                                                    <img
                                                                        src={`${store.imgUrl}${
                                                                            guard.owned ? "icon_star.png" : "icon_star_empty.png"
                                                                        }`}
                                                                        alt="Star"
                                                                        className="w-4 h-4 -translate-x-[2px]"
                                                                    />
                      ...
                      Бухгалтер
                                ...
                                <div className="p-6 space-y-4 pt-8 flex flex-col items-center text-center">
                                    ...
                                    <div className="flex justify-between gap-2 mb-6 w-full">
                                        ...
                                        >
                                            ...
                                            />
                                            <span
                                                className="absolute inset-0 flex items-center justify-center text-amber-800 shantell text-sm">
                        7 дней
                      </span>
                                        </button>
                        ...
                        30 дней
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            className="absolute inset-0 flex items-center justify-center text-blue-900 shantell text-lg font-bold">
                      Нанять
                    </span>
                                    </button>
                                </div>
