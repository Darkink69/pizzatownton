  ...
  return (
    <>
      <div className="relative min-h-screen w-full overflow-hidden">
        ...
        {/* Grid этажей дома */}
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 z-10 w-[90%]">
          <div className="flex flex-col items-center">
            {Array.from({ length: floors }, (_, index) => (
              <div
                ...
                style={{
                  marginBottom: index === floors - 1 ? "0" : "-2px", // Убираем промежутки между этажами
                }}
              >
                <img
                  src={`${store.imgUrl}${
